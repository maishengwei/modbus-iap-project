...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = RS485_1_DE_Pin|RS485_1_RE_Pin|LED3_Pin|LED2_Pin;
  ...
  GPIO_InitStruct.Pin = BOOT_SEL_PIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BOOT_SEL_PIN_GPIO_Port, &GPIO_InitStruct);
